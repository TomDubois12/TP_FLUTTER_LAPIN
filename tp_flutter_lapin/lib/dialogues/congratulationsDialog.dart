  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        child: ListBody(
          children: <Widget>[
            Text('Vous avez touché 15 lapins en ${(stopwatch.elapsed.inMicroseconds / 1000000).toStringAsFixed(4)} secondes. ($nbTaupe taupe(s) ont été touchée(s). Votre score est de : ${score}'),
